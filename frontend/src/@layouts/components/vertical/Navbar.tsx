...
const Navbar = (props: Props) => {
  ...
  return (
    <>
      {pathname !== '/client/profile' && pathname !== '/client/booking/service' && pathname !== '/client/booking/timeslot' &&  pathname !== '/client/booking/provider' &&  pathname !== '/client/booking/confirm' &&  pathname !== '/client/mybookings' &&  pathname !== '/client/dashboard' &&  (
        <StyledHeader
          theme={theme}
