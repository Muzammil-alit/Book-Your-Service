...
const TableFilters = ({ onFilterChange, carerData, selectedCarer, setSelectedCarer, loading }) => {
    ...
    const handleUserChange = (event: SelectChangeEvent) => {
        ...
        setSelectedCarer(value); // Update the selected carer in parent component
        setState(prevState => ({
            ...prevState,
            selectedUser: value
        }));
        ...
        const dateFromStr = state.dateFrom ? state.dateFrom.format() : '';
        const dateToStr = state.dateTo ? state.dateTo.format() : '';
        onFilterChange(dateFromStr, dateToStr, value);
    };
    ...
    return (
        <div className="flex flex-wrap gap-4">
            ...
            <FormControl fullWidth sx={{ width: 200, backgroundColor: 'white' }}>
                <InputLabel id="user-select-label">Carer</InputLabel>
                <Select
                    ...
                    size="small"
                >
                    <MenuItem value="0">All Carers</MenuItem>
                    {carerData.map((carer) => (
