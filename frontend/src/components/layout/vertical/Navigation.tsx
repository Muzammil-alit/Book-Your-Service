    ...
    <>
      {(userType == 1 || userType == 3) && pathname !== '/iframe' ?
        ...
        >
          ...
          <NavHeader>
            <Link href={ sessionStorage.getItem('userType') == '1' ? '/admin/dashboard' : '/carer/dashboard' }>
              {/* <Logo /> */}
              {
                !(isCollapsed && !isHovered) ? (
                  <img height={80} width={180} src='/images/AYAS-logo-square.png' alt='logo' />
                ) : (
                  <img height={60} src='/images/AYAS-logo-circle-1.png' alt='logo' />
                )
              }
            </Link>
            {!(isCollapsed && !isHovered) && (
